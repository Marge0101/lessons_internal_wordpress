...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
        <a class="skip-link screen-reader-text"
            href="#primary"><?php esc_html_e( 'Skip to content', 'theme-task' ); ?></a>
        ...
        <header id="masthead" class="site-header">
			...
			if ( !is_front_page() && !is_home()) : /* $theme_task_description || is_customize_preview()*/
                ...
                <p class="site-description">
                    <?php echo $theme_task_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                </p>
                <?php endif; ?>
            </div><!-- .site-branding -->
            ...
            <nav id="site-navigation" class="main-navigation">
                <button class="menu-toggle" aria-controls="primary-menu"
                    aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'theme-task' ); ?></button>
                <?php
			wp_nav_menu(
				array(
